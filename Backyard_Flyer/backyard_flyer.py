...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            ...
            if (abs(self.all_waypoints[0][0] - self.local_position[0]) + abs(self.all_waypoints[0][1] - self.local_position[1])) < 0.25:
    ...
    def calculate_box(self):
        ...
        """
        return [[10, 0, 3, 0], [10, 10, 3, 1.57], [0, 10, 3, 3.14], [0, 0, 3, 3/2*3.14]]
